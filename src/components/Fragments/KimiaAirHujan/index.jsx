...
const KimiaAirHujan = ({ isMobile }) => {
  const titleSize = isMobile ? "12px" : "18px";
  const options = {
    title: {
  ...
  return (
    ...
    >
      ...
      <p className="mt-3 font-semibold">
        Berikut ini dijelaskan keterangan mengenai pH air hujan.
      </p>
        ...
        <tbody className="text-gray-700">
          ...
          <tr>
            ...
            <td className="px-4 py-2">
              Air hujan sangat baik, cenderung netral seperti air permukaan
            </td>
            <td className="px-4 py-2">Tidak berbahaya</td>
          </tr>
          <tr className="bg-gray-200">
