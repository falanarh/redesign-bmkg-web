...
const series = [
  {
    ...
    data: [
      0.0244, 0.0206, 0.0282, 0.0222, 0.0222, 0.0246, 0.001, 0.0212, 0, 0.0186,
    ],
  },
];

const NitrogenDioksida = () => {
  return (
    <ContentSection
      title={
    ...
    >
      ...
      />
      <p>
        Pada bulan ini, kadar NO<sub>2</sub> tertinggi di BIVAK (0.0282 ppm) dan kadar
        terendah di SORONG (0.0000 ppm), namun masih berada di bawah Nilai Baku
        Mutu (0.08 ppm).
      </p>
    </ContentSection>
  );
