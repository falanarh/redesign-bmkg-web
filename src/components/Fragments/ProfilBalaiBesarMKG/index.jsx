    ...
    <>
      ...
      >
        <div>
          ...
          <h2 className="my-3 text-base font-semibold font-pt-sans-caption">{title}</h2>
          <h2 className="my-3 text-base font-semibold font-pt-sans">{subtitle}</h2>
...
const ProfilBalaiBesarMKG = () => {
  const [searchTerm, setSearchTerm] = useState("");

  const filteredSatelitList = profilBalaiBesarMKGList.filter((item) =>
...
export default ProfilBalaiBesarMKG;
