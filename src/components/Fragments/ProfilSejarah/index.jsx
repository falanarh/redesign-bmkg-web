...
const ProfilSejarah = () => {
  return (
        ...
        items={[
          {
            children: (
              <div>
                <p className="text-xl font-bold text-active ">Tahun 1866</p>
                <p>
                  Sejarah pengamatan meteorologi dan geofisika di Indonesia
                  dimulai pada tahun 1841 diawali dengan pengamatan yang
                  dilakukan secara perorangan oleh Dr. Onnen, Kepala Rumah Sakit
                  di Bogor. Tahun demi tahun kegiatannya berkembang sesuai
                  dengan semakin diperlukannya data hasil pengamatan cuaca dan
                  geofisika.
                </p>
              </div>
            ),
          },
          {
            children: (
              <div>
                <p className="text-xl font-bold text-active ">Tahun 1879</p>
                <p>
                  Pada tahun ini dibangun jaringan penakar hujan sebanyak 74
                  stasiun pengamatan di Jawa. Pada tahun 1902 pengamatan medan
                  magnet bumi dipindahkan dari Jakarta ke Bogor. Pengamatan
                  gempa bumi dimulai pada tahun 1908 dengan pemasangan komponen
                  horisontal seismograf Wiechert di Jakarta, sedangkan
          ...
          },
          {
            children: (
              <div>
                <p className="text-xl font-bold text-active ">Tahun 1912</p>
                <p>
                  Pada tahun ini dilakukan reorganisasi pengamatan meteorologi
                  ...
                  instansi meteorologi dan geofisika diganti menjadi Kisho Kauso
                  Kusho.
                </p>
              </div>
            ),
          },
          {
            children: (
              <div>
                <p className="text-xl font-bold text-active ">Tahun 1945</p>
                <p>
          ...
          },
          {
            children: (
              <div>
                <p className="text-xl font-bold text-active ">Tahun 1947</p>
                <p>
                  Pada tanggal 21 Juli 1947 Jawatan Meteorologi dan Geofisika
                  diambil alih oleh Pemerintah Belanda dan namanya diganti
                  menjadi Meteorologisch en Geofisiche Dienst. Sementara itu,
                  ada juga Jawatan Meteorologi dan Geofisika yang dipertahankan
                  oleh Pemerintah Republik Indonesia, kedudukan instansi
          ...
          },
          {
            children: (
              <div>
                <p className="text-xl font-bold text-active ">Tahun 1955</p>
                <p>
          ...
          },
          {
            children: (
              <div>
                <p className="text-xl font-bold text-active ">Tahun 1965</p>
                <p>
                  Pada tahun ini, nama lembaganya diubah menjadi Direktorat
                  Meteorologi dan Geofisika, kedudukannya tetap di bawah
                  Departemen Perhubungan Udara. Pada tahun 1972, Direktorat
                  Meteorologi dan Geofisika diganti namanya menjadi Pusat
                  Meteorologi dan Geofisika, suatu instansi setingkat eselon II
                  di bawah Departemen Perhubungan, dan pada tahun 1980 statusnya
                  dinaikkan menjadi suatu instansi setingkat eselon I dengan
                  nama Badan Meteorologi dan Geofisika, dengan kedudukan tetap
                  berada di bawah Departemen Perhubungan. Pada tahun 2002,
          ...
          },
          {
            children: (
              <div>
                <p className="text-xl font-bold text-active ">Tahun 2008</p>
                <p>
                  ...
                  tetap sebagai Lembaga Pemerintah Non Departemen.Pada tanggal 1
                  Oktober 2009 Undang-Undang Republik Indonesia Nomor 31 Tahun
                  2009 tentang Meteorologi, Klimatologi dan Geofisika disahkan
    ...
    //   <p className="text-2xl font-bold text-active ">Sejarah</p>

    //   <Card className="border-2 mt-7" style={{ borderRadius: "15px" }}>
