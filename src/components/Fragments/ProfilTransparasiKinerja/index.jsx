    ...
    content: [
      {
        id: 1,
        title:
          "  Laporan Realisasi Penerimaan Negara Bukan Pajak (PNBP) Bulan Januari 2014",
        // link: "https://cdn.bmkg.go.id/Web/Laporan-BMN-BMKG-Audited-2020.pdf",
      },
      {
        id: 2,
        title:
          " Laporan Realisasi Penerimaan Negara Bukan Pajak (PNBP) Bulan Februari 2014",
        // link: "https://cdn.bmkg.go.id/Web/Laporan-BMN-BMKG-Audited-2021.pdf",
      },
      {
        id: 3,
        title:
          "  Laporan Realisasi Penerimaan Negara Bukan Pajak (PNBP) Bulan Maret 2014",
        // link: "https://cdn.bmkg.go.id/Web/laporan-BMN-audited-2022.pdf",
      },
      {
        id: 4,
        title:
          "  Laporan Realisasi Penerimaan Negara Bukan Pajak (PNBP) Bulan September 2014",
        // link: "https://cdn.bmkg.go.id/Web/laporan-BMN-audited-2022.pdf",
      },
      {
        id: 5,
        title:
          "  Laporan Realisasi Penerimaan Negara Bukan Pajak (PNBP) Bulan Desember 2014",
        // link: "https://cdn.bmkg.go.id/Web/laporan-BMN-audited-2022.pdf",
      },
    ],
  },
...
const ProfilTransparasiKinerja = () => {
  return (
    <ContentSection title="Transparansi Kinerja">
      {data.map((item) => (
        <Card key={item.id} className="w-full mb-10 font-pt-sans" shadow="sm">
          ...
          <CardBody className="px-5">
            <ul className="list-disc ml-6 text-[14px]">
              {item.content.map((sentence, index) => (
                <li key={index}>
                  <a href={sentence.link} target="_blank">
                    {sentence.title}
                  </a>
                </li>
              ))}
