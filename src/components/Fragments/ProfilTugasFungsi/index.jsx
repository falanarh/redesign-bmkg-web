...
const ProfilTugasFungsi = () => {
    return (
        <div className="flex flex-col font-pt-sans">
            <p className="text-2xl font-bold text-active ">Tugas dan Fungsi</p>
            <p className="mt-4 text-[14px]">
                BMKG mempunyai status sebuah Lembaga Pemerintah Non Departemen (LPND), dipimpin oleh seorang Kepala Badan.
            </p>
            <Card className="w-full font-pt-sans mt-10" shadow="sm">
            ...
            <Card className="w-full font-pt-sans mt-10" shadow="sm">
                ...
                <CardBody className="px-5">
                    ...
                    <p className="text-[14px]">Dalam melaksanakan tugas dan fungsinya BMKG dikoordinasikan oleh Menteri yang bertanggung jawab di bidang perhubungan.</p>
                </CardBody>
            </Card>
