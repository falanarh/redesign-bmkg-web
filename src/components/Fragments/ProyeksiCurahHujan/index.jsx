...
const ProyeksiPerubahanCurahHujan = () => {
    return (
        <div className="flex flex-col font-pt-sans">
            ...
            <div>
                ...
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">1. Peta Proyeksi Perubahan Curah Hujan Kumulatif Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-01-min-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">2. Peta Proyeksi Jumlah Hari Hujan Lebat Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-02-min-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">3. Peta Proyeksi Jumlah Hari Kering Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-03-min-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">4. Peta Proyeksi Jumlah Hari Hujan Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-04-min-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">5. Peta Proyeksi Perubahan Jumlah Hari Kering Berturut-turut Terpanjang Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-05-min-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">6. Peta Proyeksi Perubahan Jumlah Hari Hujan Berturut-turut Terpanjang Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-06-min-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">7. Peta Proyeksi Perubahan Jumlah Hari Hujan Sangat Lebat Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-11-min-1-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">8. Peta Proyeksi Perubahan Jumlah Hari Hujan Ekstrem Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-12-min-1-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">9. Peta Proyeksi Perubahan Curah Hujan Harian Maksimum Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-11-min-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">10. Peta Proyeksi Perubahan Curah Hujan Kumulatif 5-Harian Maksimum Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-12-min-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">11. Peta Proyeksi Perubahan Intensitas Hujan Harian Musiman</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-15-min-1024x723.jpg'
                    />
                </div>
                <div className="mb-5">
                    <p className="text-[20px] font-bold text-active mt-3">12. Peta Proyeksi Perubahan Awal Musim Hujan</p>
                    <img className="mt-2"
                        src='https://cdn.bmkg.go.id/Web/A-16-min-1024x723.png'
                    />
                </div>
            </div>
...
export default ProyeksiPerubahanCurahHujan;